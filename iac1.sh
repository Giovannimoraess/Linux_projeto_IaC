...
useradd sebatian -m -s /bin/bash -p $(openssl passwd 1234) -G GRP_VEN
useradd robert -m -s /bin/bash -p $(openssl passwd 1234) -G GRP_VEN

useradd jose -m -s /bin/bash -p $(openssl passwd 1234) -G GRP_SEC
